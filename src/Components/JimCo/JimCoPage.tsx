    ...
    <div className="container">
      ...
      <div className="content jp__content">
        ...
        <HideWidget label="API" content="Back-end API">
          <DemoItem
            name="JimCo API"
            repos={["https://github.com/vjkrammes/JimCo.API"]}
        ...
        <HideWidget label="Retail" content="Retail web site">
          <DemoItem
            ...
            repos={["https://github.com/vjkrammes/jimco.retailsite"]}
        ...
        <HideWidget label="Portal" content="Employee portal">
          <DemoItem
            ...
            repos={["https://github.com/vjkrammes/jimco.employeeportal"]}
        ...
        <HideWidget label="Portal" content="Vendor portal">
          <DemoItem
            name="Vendor Portal"
            repos={["https://github.com/vjkrammes/jimco.vendorportal"]}
